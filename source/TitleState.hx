		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					...
					#else
					createCoolText(['Omar/Explain', 'GoldMan', 'Korenlinio', 'Ezra TigerYT']);
					#end
				// credTextShit.visible = true;
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Omar/Explain', 15);
					addMoreText('GoldMan', 15);
					addMoreText('Korenlinio', 15);
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['DO YOU WATCH OMAR MODS', 'with'], -40);
					#else
					createCoolText(['PLAY IT', 'with'], -40);
					#end
				case 8:
					//addMoreText('newgrounds', -40);
					ngSpr.visible = true;
					addMoreText('Thanks for download mods', -40);
				// credTextShit.text += '\nNewgrounds';
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
